/*
	...
	Grupo: A2
	Numero de ejercicio: Ejercicio 27 sesion 10
	Descripción del programa: Ejercicio Gaussiana con una clase
...
class Gaussiana{
	...
	private:
		double desviacion, minimo, maximo, incremento, esperanza;
	
	public:

		Gaussiana(double desv, double min, double max, double incr, double esper){
		...
		double CalcularGaussiana(double entero){
...
int main()
{
	...
	while(opcion1 == 'P'){
		...
		while(opcion2 == 'R'){
			...
			cin >> incremento;
			Gaussiana mi_gaussiana(esperanza, desviacion, minimo, maximo, incremento);

			do
			{

				resultado_total = mi_gaussiana.CalcularGaussiana(entero);
				resultado_CDF = mi_gaussiana.CDF(resultado_total);
